...
class Ui_DetailWindow(object):
    def setupUi(self, DetailWindow):
        ...
        self.project_detail_list.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.project_detail_list.setDragDropOverwriteMode(False)
        self.project_detail_list.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.project_detail_list.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
